...
!(function (t) {
    ...
    (t.event.special.movestart = {
        ...
        "function" == typeof Array.prototype.indexOf &&
            !(function (t, e) {
                for (
                    var n = ["changedTouches", "targetTouches"], a = n.length;
                    a--;

                )
                    -1 === t.event.props.indexOf(n[a]) &&
                        t.event.props.push(n[a]);
            })(t);
});
                    ...
                    c.each(function (c, d) {
                        ...
                        f.data("_b&w") ||
                            (A(f[0])
                                ...
                                : f
                                      .on("load", function () {
                                          return f.data("_b&w_loaded") ||
                                              !f[0].complete
                                              ? void setTimeout(function () {
                                                    f.load();
                                                }, 20)
                                              : (C(f, e),
                                                f.data("_b&w_loaded", !0),
                                                b--,
                                                void y(b));
                                      })
                                      .load(),
                        ...
                        q &&
                            ...
                            k
                                .unbind(l)
                                .on("resize" + l + " orientationchange" + l, D);
                },
                F = function () {
                    c.off(l), k.off(l);
                };
...
!(function (e) {
    ...
    var m = window.MutationObserver || window.WebKitMutationObserver || !1,
        ...
        w = function () {
            ...
            (n.haspointerlock =
                ...
                (n.isie =
                    "all" in document && "attachEvent" in o && !n.isopera),
        ...
        v = function (e, o) {
                    ...
                    function (r) {
                        var r = r ? r : window.event,
                            i = {
                                ...
                                type: "wheel",
                                deltaMode:
                                    "MozMousePixelScroll" == r.type ? 0 : 1,
                                deltaX: 0,
                                deltaZ: 0,
            ...
            function g(e, o, t) {
                ...
                if (
                    (0 == e.deltaMode
                        ? ((r = -Math.floor(
                              e.deltaX * (v.opt.mousescrollstep / 54)
                          )),
                          (i = -Math.floor(
                              e.deltaY * (v.opt.mousescrollstep / 54)
                          )))
                        : 1 == e.deltaMode &&
                          ((r = -Math.floor(e.deltaX * v.opt.mousescrollstep)),
                          (i = -Math.floor(e.deltaY * v.opt.mousescrollstep))),
                    o &&
                        v.opt.oneaxismousemode &&
                        0 == r &&
                        i &&
                        ((r = i), (i = 0), t))
                ) {
            ...
            (this.doc = v.opt.doc),
                ...
                (this.isrtlmode =
                    "auto" == this.opt.rtlmode
                        ? "rtl" ==
                          (this.win[0] == window ? this.body : this.win).css(
                              "direction"
                          )
                        : this.opt.rtlmode === !0),
            ...
            (this.getDocumentScrollOffset = function () {
                ...
                (this.updateScrollBar = function (e) {
                    if (v.ishwscroll)
                        v.rail.css({
                            height:
                                v.win.innerHeight() -
                                (v.opt.railpadding.top +
                                    v.opt.railpadding.bottom),
                        }),
                            v.railh &&
                                v.railh.css({
                                    width:
                ...
                (this.init = function () {
                    ...
                    if (
                        ...
                        v.ispage ||
                            "auto" == v.zindex ||
                            (v.zindex > l && (l = v.zindex)),
                        v.isie &&
                            0 == v.zindex &&
                            "auto" == v.opt.zindex &&
                            (v.zindex = "auto"),
                        !v.ispage ||
                            (!x.cantouch && !x.isieold && !x.isie9mobile))
                    ) {
                        var e = v.docscroll;
                        v.ispage && (e = v.haswrapper ? v.win : v.doc),
                            x.isie9mobile ||
                                v.css(e, { "overflow-y": "hidden" }),
                            v.ispage &&
                                x.isie7 &&
                        ...
                        o.css({
                            ...
                            (o.hborder = parseFloat(
                                o.outerHeight() - o.innerHeight()
                            )),
                        ...
                        !v.opt.boxzoom ||
                            ...
                            v.zoom.css({
                                ...
                                "z-index": v.zindex,
                                backgroundImage:
                                    "url(" + v.opt.scriptpath + "zoomico.png)",
                                height: 18,
                                width: 18,
                                backgroundPosition: "0px 0px",
                            }),
                            v.opt.dblclickzoom &&
                                v.bind(v.win, "dblclick", v.doZoom),
                            x.cantouch &&
                                v.opt.gesturezoom &&
                        ...
                        if (v.opt.horizrailenabled) {
                            ...
                            o.css({
                                ...
                                "-webkit-border-radius":
                                    v.opt.cursorborderradius,
                                "-moz-border-radius": v.opt.cursorborderradius,
                                "border-radius": v.opt.cursorborderradius,
                            }),
                                x.isieold && o.css({ overflow: "hidden" }),
                                (o.wborder = parseFloat(
                        ...
                        if (v.ispage)
                            ...
                            if (v.ishwscroll) {
                                ...
                                v.isfixed ||
                                    (v.viewport = v.getViewport(v.win[0])),
                                    v.viewport &&
                                        ((v.body = v.viewport),
                                        0 ==
                                            /fixed|absolute/.test(
                        ...
                        if (
                            (v.opt.autohidemode === !1
                                ...
                                : v.opt.autohidemode === !0 ||
                                  "leave" === v.opt.autohidemode
                                ? ((v.autohidedom = a().add(v.rail)),
                                  x.isie8 &&
                                      (v.autohidedom = v.autohidedom.add(
                                          v.cursor
                                      )),
                                  v.railh &&
                                      (v.autohidedom = v.autohidedom.add(
                            ...
                            (v.scrollmom = new b(v)),
                                (v.onmangotouch = function () {
                                    ...
                                    if (0 != i) {
                                        ...
                                        if (
                                            (v.mangotouch.lazy &&
                                                clearTimeout(v.mangotouch.lazy),
                            ...
                            x.hasw3ctouch
                                ...
                                x.cantouch || v.opt.touchbehavior
                                    ? (v.bind(
                                      ...
                                      v.onclick &&
                                          v.bind(document, "click", v.onclick),
                                      v.opt.cursordragontouch &&
                                          (v.bind(
                                              v.cursor,
                                              "mousedown",
                    ...
                    if (
                        ...
                        if (
                            (v.autohidedom &&
                                (v.autohidedom
                                    .stop()
                                    .css({ opacity: v.opt.cursoropacitymax }),
                                (v.cursoractive = !0)),
                ...
                (this.onResize = function (e, o) {
                    ...
                    if (!v.haswrapper && !v.ispage) {
                        if ("none" == v.win.css("display"))
                            return (
                                v.visibility && v.hideRail().hideRailHr(), !1
                            );
                    ...
                    if (
                        ((v.view = {
                            w: v.ispage
                                ? v.win.width()
                                : parseInt(v.win[0].clientWidth),
                            h: v.ispage
                                ? v.win.height()
                                : parseInt(v.win[0].clientHeight),
                        }),
                    ...
                    return (
                        ...
                        v.scroll.y &&
                            0 == v.getScrollTop() &&
                            v.doScrollTo(
                                Math.floor(v.scroll.y * v.scrollratio.y)
                            ),
                        v
                    );
                }),
                ...
                (this.onmousewheel = function (e) {
                    if (!v.wheelprevented) {
                        if (v.railslocked)
                            return (
                                v.debounced("checkunlock", v.resize, 250), !0
                            );
                        ...
                        if (
                            ...
                            return v.railh && v.railh.scrollable
                                ? v.onmousewheelhr(e)
                                : !0;
                        var o = +new Date(),
                            t = !1;
                        if (
                            (v.opt.preservenativescrolling &&
                                v.checkarea + 600 < o &&
                                ((v.nativescrollingarea = v.isScrollable(e)),
                                (t = !0)),
                            (v.checkarea = o),
                ...
                (this.getTransitionSpeed = function (e) {
                    var o = Math.round(10 * v.opt.scrollspeed),
                        t = Math.min(
                            o,
                            Math.round((e / 20) * v.opt.scrollspeed)
                        );
                    return t > 20 ? t : 0;
                }),
                v.opt.smoothscroll
                        ...
                        ? ((this.prepareTransition = function (e, o) {
                          ...
                          (this.onScrollTransitionEnd = function () {
                              ...
                              return (
                                  ...
                                  0 > e
                                      ? (e = 0)
                                      : e > v.page.maxh && (e = v.page.maxh),
                                  0 > o
                                      ? (o = 0)
                                      : o > v.page.maxw && (o = v.page.maxw),
                ...
                (this.doScrollBy = function (e, o) {
                    ...
                    if (v.bouncescroll) {
                        ...
                        -i > t
                            ? (t = -i)
                            : t > v.page.maxh + i && (t = v.page.maxh + i);
                    }
                    v.cursorfreezed = !1;
                ...
                (this.doScrollLeftBy = function (e, o) {
                    ...
                    if (v.bouncescroll) {
                        ...
                        -i > t
                            ? (t = -i)
                            : t > v.page.maxw + i && (t = v.page.maxw + i);
                    }
                    v.cursorfreezed = !1;
                ...
                (this.doZoomIn = function (e) {
                    if (!v.zoomactive) {
                        ...
                        for (var r in o) {
                            var i = o[r];
                            v.zoomrestore.style[i] =
                                "undefined" != typeof t[i] ? t[i] : "";
                        }
                ...
                (this.doZoomOut = function (e) {
                    return v.zoomactive
                        ? ((v.zoomactive = !1),
                          ...
                          x.isios4 &&
                              a(window).scrollTop(v.zoomrestore.scrollTop),
                ...
                (this.resizeZoom = function () {
                    if (v.zoomactive) {
                        ...
                        v.win.css({
                            width:
                                a(window).width() -
                                v.zoomrestore.padding.w +
                                "px",
                            height:
                                a(window).height() -
                                v.zoomrestore.padding.h +
                                "px",
                        }),
                            v.onResize(),
    ...
    (e.cssHooks.pageYOffset = {
        ...
        set: function (e, o) {
            ...
            return (
                t && t.ishwscroll ? t.setScrollTop(parseInt(o)) : y.call(e, o),
                this
            );
        },
    }),
    ...
    (a.cssHooks.pageXOffset = {
        ...
        set: function (e, o) {
            var t = a.data(e, "__nicescroll") || !1;
            return (
                t && t.ishwscroll ? t.setScrollLeft(parseInt(o)) : x.call(e, o),
                this
            );
        },
    }),
...
(function ($) {
    ...
    function nv_showNavi(a, b, c) {
        var d = is_number(a.items.minimum)
            ? a.items.minimum
            : a.items.visible + 1;
    ...
    function go_getObject(a, b) {
        return (
            is_function(b) ? (b = b.call(a)) : is_undefined(b) && (b = {}), b
        );
    }
    ...
    function gn_getScrollItemsNextFilter(a, b, c, d) {
        return (
            gn_getItemsNextFilter(a, b.items.filter, d + 1, c, b.circular) - 1
        );
    }
            ...
            a[b.d.width] ||
                (b.responsive
                    ? (debug(!0, "Set a " + b.d.width + " for the items!"),
                      (a[b.d.width] = ms_getTrueLargestSize(
                          c,
                          b,
                          "outerWidth"
                      )))
    ...
    function in_complementVisibleItems(a, b) {
        return (
            "variable" == a.items[a.d.width] &&
                (a.items.visibleConf.variable = !0),
            a.items.visibleConf.variable ||
                (is_number(a[a.d.width])
                    ? (a.items.visible = Math.floor(
                          a[a.d.width] / a.items[a.d.width]
                      ))
    ...
    function in_complementPrimarySize(a, b, c) {
        return (
            "auto" == a && (a = ms_getTrueLargestSize(c, b, "outerWidth")), a
        );
    }
            ...
            function (options, configs) {
                ...
                (FN._init = function (a, b, c) {
                    (a = go_getObject($tt0, a)),
                        ...
                        (a.mousewheel = go_getMousewheelObject(
                            $tt0,
                            a.mousewheel
                        )),
                        b &&
                        ...
                        FN._unbind_events(),
                            ...
                            $cfs.bind(
                                ...
                                function (a, b, c, d, e) {
                                    ...
                                    if (
                                        ((tmrs.timePassed = 0),
                                        $cfs.trigger(cf_e("slide_" + j, conf), [
                                            b,
                                            c,
                                        ]),
                                        opts.synchronise)
                            ...
                            $cfs.bind(
                                ...
                                function (a, b, c) {
                                    ...
                                    if (
                                        (sz_resetMargin(d, opts), !is_number(c))
                                    ) {
                                        if (opts.items.visibleConf.variable)
                                            c = gn_getVisibleItemsPrev(
                                                d,
                                                opts,
                                                itms.total - 1
                                            );
                                    ...
                                    if (
                                        ...
                                        var f = gn_getVisibleItemsNextFilter(
                                            d,
                                            opts,
                                            itms.total - c
                                        );
                            ...
                            $cfs.bind(
                                ...
                                function (a, b, c) {
                                    ...
                                    if (!opts.circular) {
                                        if (opts.items.visibleConf.variable)
                                            var g = gn_getVisibleItemsNext(
                                                    d,
                                                    opts,
                                                    c
                                                ),
                                                e = gn_getVisibleItemsPrev(
                                                    d,
                                                    opts,
                                                    f - 1
                                                );
                                    ...
                                    if (
                                        ...
                                        var g = gn_getVisibleItemsNextFilter(
                                            d,
                                            opts,
                                            c
                                        );
                                    ...
                                    if (
                                        ...
                                        if (itms.total > 0)
                                            for (; b > itms.total; )
                                                b -= itms.total;
                                        $cfs.prepend(
                                            $cfs.children().slice(b, itms.total)
                                        );
                                    }
                                    return !0;
                                }
                    ...
                    (FN._bind_buttons = function () {
                        ...
                        if (
                                ...
                                $(document).bind(
                                    ...
                                    function (a) {
                                        ...
                                        b >= 49 &&
                                            58 > b &&
                                            ((b =
                                                (b - 49) * opts.items.visible),
                                            itms.total >= b &&
                                                (a.preventDefault(),
                                                $cfs.trigger(
                                                    cf_e("slideTo", conf),
                                                    [b, 0, !0, opts.pagination]
                                                )));
                                    }
                                ),
                            $.fn.swipe)
                            ...
                            if (
                                (b && opts.swipe.onTouch) ||
                                (!b && opts.swipe.onMouse)
                            ) {
